				...
				<div class="row">
					<div class="col-md-12">
						<div class="block text-center">
							...
							<h1 class="text-capitalize mb-4 text-lg">닉네임 님 환영합니다.</h1>
						...
						<div class="sidebar-wrap">
							...
							<div class="sidebar-widget card border-0 mb-3">
								...
								<div class="card-body p-4 text-center">
									...
									<!-- 닉네임 삽입부분 -->
									<h5 class="mb-0 mt-4">닉네임 님 어서오세요</h5>
									<br>
									...
									<a href="/store/update" class="btn btn-small btn-main btn-round-full">회원정보 수정</a>
									<a href="/product/product_register" class="btn btn-small btn-main btn-round-full">상품등록</a>
							...
							<div class="sidebar-widget latest-post card border-0 p-4 mb-3">
								...
								<div class="media border-bottom py-3">
									...
									<div class="media-body">
										<h6 class="my-2">
											...
											<!-- 문의글 제목 및 해당 문의글 경로 -->
											<a href="board_view">게시물1 제목</a>
										</h6>

										<!-- 문의글 올린 날짜 -->
										<span class="text-sm text-muted" style="font-family: 'Poppins', sans-serif;">게시물1 올린 날짜</span>
									</div>
								</div>
								<!-- 문의글 Close -->
								...
								<div class="media border-bottom py-3">
									...
									<div class="media-body">
										<h6 class="my-2">
											<a href="board_view">게시물2 제목</a>
										</h6>
										<span class="text-sm text-muted" style="font-family: 'Poppins', sans-serif;">게시물2 올린 날짜</span>
									</div>
								</div>
								<!-- 문의글 Close -->
								...
								<div class="media py-3">
									...
									<div class="media-body">
										<h6 class="my-2">
											<a href="board_view">게시물3 제목</a>
										</h6>
										<span class="text-sm text-muted" style="font-family: 'Poppins', sans-serif;">게시물3 올린 날짜</span>
									</div>
								</div>
								<!-- 문의글 Close -->
								...
								<nav class="navigation pagination py-2 d-inline-block" style="float: right;">
									<div class="nav-links">
										<a class="prev page-numbers" href="#" style="font-size: 13px;">Prev</a>
										<span aria-current="page" class="page-numbers current" style="font-size: 13px;">1</span> <a
											class="page-numbers" href="#" style="font-size: 13px;">2</a> <a class="next page-numbers" href="#"
											style="font-size: 13px;">Next</a>
									</div>
								</nav>
								<!-- 페이지 넘버링 Close -->
							</div>
							...
							<tbody>
								...
								<tr>
									<td>
										<div class="n-prd-row">
											<!-- 사진부분 -->
											<a href="/app/goods/938746/0" class="img-block"> <img
													src="//image.msscdn.net/images/goods_img/20190123/938746/938746_5_100.jpg"
													alt="CORDURA AUTHENTIC LOGO RUCK SACK BLACK">
											</a>
											<!-- 상품정보 -->
											<ul class="info">
												<li class="brand"><a href="#">상호명</a></li>
												<li class="name"><a href="#">제품명</a></li>
											</ul>
										</div>
									</td>
									<!-- 주문일자 및 등등 -->
									<td>주문일자</td>
									<td><a href="#">주문번호</a></td>
									<td>80,100원<br> <span class="txt-default">1개</span></td>
									<td>
										<div class="btn-set">
											<br> <a class="btn btn-small btn-main btn-round-full" onclick="showpopup();">배송조회</a>
											<br><br> <a class="btn btn-small btn-main btn-round-full" onclick="showpopup();">환불</a>
										</div>
									</td>
									<td>
										o
									...
									<div class="blog-item-content bg-white p-4">
										<div class="blog-item-meta  py-1 px-2">
											<span class="text-muted text-capitalize mr-3" style="font-family: 'Poppins', sans-serif;"><i
													class="ti-pencil-alt mr-2"></i>상호명</span>
										</div>

										<h3 class="mt-3 mb-3">
											<a href="blog-single.html">상품명</a>
										</h3>
										<p class="mb-4" style="font-family: 'Poppins', sans-serif;">상품정보</p>

										<a href="blog-single.html" class="btn btn-small btn-main btn-round-full">주문하기</a>
									</div>
								</div>
							</div>
							<!-- 상품 Close -->
